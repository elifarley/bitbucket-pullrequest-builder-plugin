...
public class ApiClient {
    ...
    private <R> R parse(String response, Class<R> cls) throws IOException {
        ...
        try {
            ...
            IOException ioException = new IOException("Unable to parse response to class '" +
    ...
    private <R> R parse(String response, JavaType type) throws IOException {
        ...
        try{
            ...
            IOException ioException = new IOException("Unable to parse response to Java type '" +
                    type.toString() + "' (\n" + response +
                    "\n)");
            ioException.initCause(e);
            throw ioException;
    ...
    private <R> R parse(String response, TypeReference<R> ref) throws IOException {
        ...
        try{
            ...
            IOException ioException = new IOException("Unable to parse response to type reference '" +
